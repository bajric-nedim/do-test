...
@InputType()
class ReservationUpdateManyWithoutAppointmentsInput {
...
export { ReservationUpdateManyWithoutAppointmentsInput as ReservationUpdateManyWithoutAppointmentsInput };
