...
@InputType()
class ReservationCreateNestedManyWithoutAppointmentsInput {
...
export { ReservationCreateNestedManyWithoutAppointmentsInput as ReservationCreateNestedManyWithoutAppointmentsInput };
