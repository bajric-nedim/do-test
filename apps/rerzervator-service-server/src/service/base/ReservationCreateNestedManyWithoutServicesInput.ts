...
@InputType()
class ReservationCreateNestedManyWithoutServicesInput {
...
export { ReservationCreateNestedManyWithoutServicesInput as ReservationCreateNestedManyWithoutServicesInput };
